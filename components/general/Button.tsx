    ...
    if(link) {
        return (
            <Link href={link} className="w-2/3 rounded-lg py-1 flex justify-center items-center transition-all text-primary text-lg
                border border-neutral-300 dark:border-zinc-500 dark:text-zinc-400 hover:bg-neutral-700 dark:hover:bg-zinc-500 dark:hover:text-neutral-50 hover:text-neutral-50">
                {text}
            </Link>
        )
    } else {
